...
let scheduled = function(readonlyMode, req, res) {
    ...
    if (readonlyMode) {
        ...
        if (0 == readonlyCount) {
            ...
            const techsol_config_json = JSON.parse('{"name":"ts-autotagcreatives-codebuild","client":"Quotient","mm_orgs":[101656],"debug":"true","lookback-days":1,"tags":[{"tag_check_string":"z.moatads.com/quotientmediamath778352909812/moatad.js","tag":"<noscript class=\"MOAT-quotientmediamath778352909812?moatClientLevel1=[AD_ATTR.advertiser]&amp;moatClientLevel2=[AD_ATTR.campaign]&amp;moatClientLevel3=[AD_ATTR.strategy]&amp;moatClientLevel4=[AD_ATTR.creative]&amp;moatClientSlicer1=[BID_ATTR.site]&amp;zMoatSZ=[AD_ATTR.width]x[AD_ATTR.height]\"></noscript><script src=\"https://z.moatads.com/quotientmediamath778352909812/moatad.js#moatClientLevel1=[AD_ATTR.advertiser]&moatClientLevel2=[AD_ATTR.campaign]&moatClientLevel3=[AD_ATTR.strategy]&moatClientLevel4=[AD_ATTR.creative]&moatClientSlicer1=[BID_ATTR.site]&zMoatSZ=[AD_ATTR.width]x[AD_ATTR.height]\" type=\"text/javascript\"></script>","enabled":"true"},{"tag_check_string":"s.thebrighttag.com/px?site=i54834M","tag":"<img style=\"visibility:hidden;display:none;\" height=\"1\" width=\"1\" src=\"https://s.thebrighttag.com/px?site=i54834M&referrer=ad%3Aimp&channel=MM&cr=[AD_ATTR.creative]&line=[AD_ATTR.strategy]\">","enabled":"false"}]}');
            t1Api.login()
                .then(() => {
